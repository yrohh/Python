...
def btncmd() :
    ...
    msgbox.showinfo("Alarm", f'Alarm up at {qtime}\
         \nDon\'t worry about the main window stopping :)')
...
root.geometry("400x160+700+350") # 윈도우 크기 & 출력 좌표 지정.
root.resizable(False, False) # 창 크기 고정.

emptylab1 = Label(root, text="", height= 1)
emptylab1.pack()
...
emptylab2 = Label(root, text="", height= 2)
emptylab2.pack()

btn1 = Button(root, width=13, height=2, text="Start", command=btncmd) # (객체, 가로 크기, 세로 크기, 버튼 텍스트, 실행 함수)
'''
